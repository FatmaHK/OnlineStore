...
public class Test_MinSoldProdcut extends ProjectTests {
	...
	@Test
	public void test1_minSoldProduct_storeExist() throws Exception {
		
		StatisticsCommand stat = new minSoldProduct(spRepo);
		StatResult result = stat.execute(1);
		Assert.assertEquals("product1", result.statEntity);
	}
	
	@Test
	public void test2_minSoldProduct_notExistingStore() throws Exception {
		StatisticsCommand stat = new minSoldProduct(spRepo);
	...
	@Test
	public void test3_minSoldProduct_storeWithNoProducts() throws Exception {
		StatisticsCommand stat = new minSoldProduct(spRepo);
