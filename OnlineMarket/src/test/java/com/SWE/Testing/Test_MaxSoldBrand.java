...
public class Test_MaxSoldBrand extends ProjectTests {
	...
	@Test
	public void test1_maxSoldBrand_storeExist() throws Exception {
		
		StatisticsCommand stat = new maxSoldBrand(sbRepo);
		StatResult result = stat.execute(1);
		Assert.assertEquals("b2", result.statEntity);
	}
	
	@Test
	public void test2_maxSoldBrand_notExistingStore() throws Exception {
		StatisticsCommand stat = new maxSoldBrand(sbRepo);
	...
	@Test
	public void test3_maxSoldBrand_storeWithNoBrands() throws Exception {
		StatisticsCommand stat = new maxSoldBrand(sbRepo);
